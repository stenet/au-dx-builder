...
export class DxProgressBar implements IDx<DevExpress.ui.dxProgressBar>, IDxElement {
  ...
  optionNames: string[] = ["disabled", "elementAttr", "height", "hint", "hoverStateEnabled", "isValid", "max", "min", "onComplete", "onContentReady", "onDisposing", "onInitialized", "onOptionChanged", "onValueChanged", "readOnly", "rtlEnabled", "showStatus", "statusFormat", "validationError", "validationMessageMode", "value", "visible", "width"];
